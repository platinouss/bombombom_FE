...
export default function StudyAbout({
  ...
  return (
    <div className="max-w-sm p-4 mr-auto">
      ...
      <div className="mt-4 space-y-2">
        ...
        <div className="flex items-center space-x-2">
          ...
          <b>{details.headCount + ' / ' + details.capacity}</b>
        </div>
        <div className="flex items-center space-x-2">
      ...
      <div className="mt-6">
        <h3 className="text-lg font-bold">
          스터디원{' '}
          <span className="text-sm font-normal">({details.headCount})</span>
        </h3>
...
function PenaltyIcon() {
  return (
    <div className="rounded-full bg-[#ff7675] w-5 h-5 flex items-center justify-center text-white text-xs font-medium">
      $
    </div>
  );
}
